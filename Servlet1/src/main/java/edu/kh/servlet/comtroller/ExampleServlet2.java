...
// 어노테이션(Anotation) : 컴파일러가 읽고 해석하는 주석

// @WebServlet("요청주소") 어노테이션
// - 컴파일시 web.xml파일에 해당클래스를 
//   Servlet으로 등록하는 <servlet>태그 작성하고
//	 "요청주소"와 매핑되도록 <servlet-mapping 태그 작성하게 함

// *** 주의사항 *** : 요청 주소는 반드시 "/" 부터 시작 해야 한다!!
...
public class ExampleServlet2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		sb.append("<button onclik='history.back()'>돌아가기</button>");
