...
<body>
 ...
 <%-- form 태그 : input 태그에 입력된 값과 select, option 태그의 선택된 
 메뉴값이 form 태그의 method 속성을 요청 보내는것 --%>
  ...
  <form action="/fr/forward">
    forward 입력1 : <input type="text" name="forwardInput1">
    <br>
    forward 입력2 : <input type="text" name="forwardInput2">
    <button>forward 확인하기</button>
  </form>

  <hr>

  <h3>redirect (redirection의 줄임말(재 요청, 다른 Servlet 요청))</h3>
  <pre>
